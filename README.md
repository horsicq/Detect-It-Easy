...
|  🛠️ | **Toolchain / platform**     | Compiler, linker, and language inference from mangled symbols, Rich records, runtime libraries, section layout, and source-file residue, plus Windows-facing markers such as AppContainer and Game Definition File data.                                                                                              |
